...
public class Session extends Application {
    ...
    private static long reminderUnixTime;

    // ---------------------------------------------------

    public static void setReminderUnixTime(long reminderUnixTime){
        Session.reminderUnixTime = reminderUnixTime;
    }

    public static long getReminderUnixTime(){
        return reminderUnixTime;
    }
