...
import ulster.serg.tautreminderapp.controller.sensors.legacy.sensor.location.common.RejectionHandler;
...
class Gpx10AnnotateHandler implements Runnable {
    String LOG = "GPX10AnnotateHandler";
    String description;
    File gpxFile;
    Location loc;
    ...
    public void run() {
        ...
        synchronized (Gpx10FileLogger.lock) {
            ...
            try {
                ...
                Log.w(LOG, "Writing to: " + gpxTempFile.getAbsolutePath());
