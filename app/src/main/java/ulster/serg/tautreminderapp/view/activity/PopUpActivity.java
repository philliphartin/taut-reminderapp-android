...
public class PopUpActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ulster.serg.tautreminderapp.R.layout.activity_reminderpopup);

        //Init UI elements
        TextView tv_desc = (TextView) findViewById(ulster.serg.tautreminderapp.R.id.textView_dialog_reminderpopup_desc);
        TextView tv_type = (TextView) findViewById(ulster.serg.tautreminderapp.R.id.textView_dialog_reminderpopup_type);
        ImageView imageView_reminderType = (ImageView) findViewById(ulster.serg.tautreminderapp.R.id.popupImage);
        ...
        if (reminderHelper.isVoiceReminder(reminder)) {
            ...
            playReminderBtn.setCompoundDrawablesWithIntrinsicBounds(0, 0, ulster.serg.tautreminderapp.R.drawable.audio_listen, 0);
            playReminderBtn.setBackgroundResource(ulster.serg.tautreminderapp.R.drawable.button_all);
            ...
            //Get FrameLayout
            FrameLayout frameLayout = (FrameLayout) findViewById(ulster.serg.tautreminderapp.R.id.layout_popupImage);
        ...
        Button button_acknowledge = (Button) findViewById(ulster.serg.tautreminderapp.R.id.button_dialog_reminderpopup_ok);
    ...
    private void startPopUpSoundAndVibration() {
        //Sound
        notificationPlayer = MediaPlayer.create(this, ulster.serg.tautreminderapp.R.raw.sound);
    ...
    private void enableOKButton(boolean isEnable) {
        Button button = (Button) findViewById(ulster.serg.tautreminderapp.R.id.button_dialog_reminderpopup_ok);
        button.setEnabled(isEnable);
    }

    private int getImageForReminderType(String type) {
        if ("Medication".equals(type)) {
            return ulster.serg.tautreminderapp.R.drawable.medication_big;
        } else if ("Appointment".equals(type)) {
            return ulster.serg.tautreminderapp.R.drawable.clock_big;
        } else if ("Meal".equals(type)) {
            return ulster.serg.tautreminderapp.R.drawable.teachers_day_big;
        } else if ("Drink".equals(type)) {
            return ulster.serg.tautreminderapp.R.drawable.plastic_bottle_big;
        } else if ("Personal Hygiene".equals(type)) {
            return ulster.serg.tautreminderapp.R.drawable.hygiene_big;
        } else if ("Charge Phone".equals(type)) {
            return ulster.serg.tautreminderapp.R.drawable.charge_big;
        } else if ("Other".equals(type)) {
            return ulster.serg.tautreminderapp.R.drawable.info_big;
        } else {
            return ulster.serg.tautreminderapp.R.drawable.info_big;
        }
    }
