...
public class CreateNewReminderActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ulster.serg.tautreminderapp.R.layout.activity_new_reminder);
        if (savedInstanceState == null) {
            getFragmentManager().beginTransaction()
                    .add(ulster.serg.tautreminderapp.R.id.container, new FormatChoiceFragment())
                    .commit();
        }
    ...
    public static class FormatChoiceFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(ulster.serg.tautreminderapp.R.layout.fragment_new_reminder_formatchoice, container, false);

            //Init UI elements
            Button button_basicReminder = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_createbasic);
            button_basicReminder.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    reminder.setFormat("basic");
                    getFragmentManager().beginTransaction()
                            .replace(ulster.serg.tautreminderapp.R.id.container, new PickDateFragment(), fTAG_pickdate)
                            .addToBackStack(null)
                            .commit();
                }
            });
            ...
            Button button_voiceReminder = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_createvoice);
            button_voiceReminder.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    reminder.setFormat("voice");
                    getFragmentManager().beginTransaction()
                            .replace(ulster.serg.tautreminderapp.R.id.container, new RecordVoiceFragment(), fTAG_recordvoice)
                            .addToBackStack(null)
                            .commit();
                }
            });
    ...
    public static class RecordVoiceFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            final View rootView = inflater.inflate(ulster.serg.tautreminderapp.R.layout.fragment_new_reminder_recordvoice, container, false);
            Button button_next = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_new_reminder_next);
            ...
            //Recording Buttons
            Button button_start = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.btnStart);
            Button button_stop = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.btnStop);
            Button button_play = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.btnPlay);
        ...
        private void playButton(boolean recorded, View view) {
            enableButton(ulster.serg.tautreminderapp.R.id.btnPlay, recorded, view);
        }

        private void enableButtons(boolean isRecording, View view) {
            enableButton(ulster.serg.tautreminderapp.R.id.btnStart, !isRecording, view);
            enableButton(ulster.serg.tautreminderapp.R.id.btnPlay, !isRecording, view);
            enableButton(ulster.serg.tautreminderapp.R.id.btnStop, isRecording, view);
        }
    ...
    public static class PickDateFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(ulster.serg.tautreminderapp.R.layout.fragment_new_reminder_pickdate, container, false);
            ...
            button_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (allComplete(complete)) {
                        ...
                        getFragmentManager().beginTransaction()
                                .hide(getFragmentManager().findFragmentByTag(currentFragment))
                                .add(ulster.serg.tautreminderapp.R.id.container, new ADLTypeFragment(), fTAG_adltype)
                                .addToBackStack(null)
                                .commit();
                    }
                }
            ...
            button_pickDate = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_newreminder_DATE);
            ...
            button_pickTime = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_newreminder_TIME);
    ...
    public static class ADLTypeFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(ulster.serg.tautreminderapp.R.layout.fragment_new_reminder_adltype, container, false);
            ...
            button_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (descriptionEntered()) {
                        ...
                        getFragmentManager().beginTransaction()
                                .hide(getFragmentManager().findFragmentByTag(currentFragment))
                                .add(ulster.serg.tautreminderapp.R.id.container, new RepeatFrequencyFragment(), fTAG_repeatfrequency)
                                .addToBackStack(null)
                                .commit();
                    } else {
            ...
            spinnerADLType = (Spinner) rootView.findViewById(ulster.serg.tautreminderapp.R.id.spinner_fragment_new_reminder_adltype);
            editTextDescription = (EditText) rootView.findViewById(ulster.serg.tautreminderapp.R.id.edittext_fragment_new_reminder_adltype);
            return rootView;
        }
    ...
    public static class RepeatFrequencyFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(ulster.serg.tautreminderapp.R.layout.fragment_new_reminder_repeatfrequency, container, false);

            //Init UI elements
            layout_customOptions = (LinearLayout) rootView.findViewById(ulster.serg.tautreminderapp.R.id.layout_custom_hide);

            radioButton_custom = (RadioButton) rootView.findViewById(ulster.serg.tautreminderapp.R.id.radioButton_new_reminder2_custom);
            radioButton_daily = (RadioButton) rootView.findViewById(ulster.serg.tautreminderapp.R.id.radioButton_new_reminder2_everyday);
            radioButton_weekly = (RadioButton) rootView.findViewById(ulster.serg.tautreminderapp.R.id.radioButton_new_reminder2_weekly);
            radioButton_weekly.setText("Weekly " + "(" + getRepeatDay() + ")");

            checkBox_mon = (CheckBox) rootView.findViewById(ulster.serg.tautreminderapp.R.id.checkBox_mon);
            checkBox_tue = (CheckBox) rootView.findViewById(ulster.serg.tautreminderapp.R.id.checkBox_tue);
            checkBox_wed = (CheckBox) rootView.findViewById(ulster.serg.tautreminderapp.R.id.checkBox_wed);
            checkBox_thu = (CheckBox) rootView.findViewById(ulster.serg.tautreminderapp.R.id.checkBox_thu);
            checkBox_fri = (CheckBox) rootView.findViewById(ulster.serg.tautreminderapp.R.id.checkBox_fri);
            checkBox_sat = (CheckBox) rootView.findViewById(ulster.serg.tautreminderapp.R.id.checkBox_sat);
            checkBox_sun = (CheckBox) rootView.findViewById(ulster.serg.tautreminderapp.R.id.checkBox_sun);
            ...
            //RADIOGROUP LISTENER
            radioGroup = (RadioGroup) rootView.findViewById(ulster.serg.tautreminderapp.R.id.radioGroup_new_reminder2_rg);
            radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    switch (checkedId) {
                        case ulster.serg.tautreminderapp.R.id.radioButton_new_reminder2_never:
                            repeat = "Never";
                            layout_customOptions.setVisibility(View.GONE);
                            break;
                        case ulster.serg.tautreminderapp.R.id.radioButton_new_reminder2_everyday:
                            repeat = "Everyday";
                            layout_customOptions.setVisibility(View.GONE);
                            break;
                        case ulster.serg.tautreminderapp.R.id.radioButton_new_reminder2_weekly:
                            repeat = "Weekly";
                            layout_customOptions.setVisibility(View.GONE);
                            break;
                        case ulster.serg.tautreminderapp.R.id.radioButton_new_reminder2_custom:
                            repeat = "Custom";
        ...
        private void navigateToNextScreen() {
            ...
            if (preferencesHelper.anyCarerEnabled()) {
                getFragmentManager().beginTransaction()
                        .hide(getFragmentManager().findFragmentByTag(currentFragment))
                        .add(ulster.serg.tautreminderapp.R.id.container, new UserCheckFragment(), fTAG_checkuser)
                        .addToBackStack(null)
                        .commit();
            } else {
                ...
                getFragmentManager().beginTransaction()
                        .hide(getFragmentManager().findFragmentByTag(currentFragment))
                        .add(ulster.serg.tautreminderapp.R.id.container, new ConfirmDetailsFragment(), fTAG_confirmdetails)
                        .addToBackStack(null)
                        .commit();
            }
        }
    ...
    public static class UserCheckFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(ulster.serg.tautreminderapp.R.layout.fragment_new_reminder_checkuser, container, false);

            final PreferencesHelper preferencesHelper = new PreferencesHelper(getActivity());

            //Init UI elements
            TextView textView_userName = (TextView) rootView.findViewById(ulster.serg.tautreminderapp.R.id.textView_userCheck);
            textView_userName.setText("Is this " + preferencesHelper.getUserName() + "?");

            Button button_participant = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_new_reminder_checkuser_participant);
            ...
            Button button_carer = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_new_reminder_checkuser_carer);
    ...
    public static class ConfirmDetailsFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(ulster.serg.tautreminderapp.R.layout.fragment_new_reminder_confirmdetails, container, false);

            context = getActivity();
            //Init UI Elements
            customDaysLayout = (LinearLayout) rootView.findViewById(ulster.serg.tautreminderapp.R.id.linearLayout_customdays);
            customDaysText = (TextView) rootView.findViewById(ulster.serg.tautreminderapp.R.id.textView_customdays);
            checkCustomDaysLayout();

            TextView tv_date = (TextView) rootView.findViewById(ulster.serg.tautreminderapp.R.id.textView_save_date);
            TextView tv_time = (TextView) rootView.findViewById(ulster.serg.tautreminderapp.R.id.textView_save_time);
            TextView tv_type = (TextView) rootView.findViewById(ulster.serg.tautreminderapp.R.id.textView_save_type);
            TextView tv_repeat = (TextView) rootView.findViewById(ulster.serg.tautreminderapp.R.id.textView_save_repeat);
            ...
            Button button_save = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_new_reminder_save_confirm);
            ...
            Button button_cancel = (Button) rootView.findViewById(ulster.serg.tautreminderapp.R.id.button_new_reminder_save_cancel);
